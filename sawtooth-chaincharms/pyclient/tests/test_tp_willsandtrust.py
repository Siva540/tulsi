...
from wills.willsandtrust_message_factory import WillsAndTrustMessageFactory

LOGGER = logging.getLogger(__name__)


class TestWillsAndTrust(TransactionProcessorTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()

        cls.wallet = WillsAndTrustMessageFactory()
